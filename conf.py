...
BLOG_AUTHOR = "SIW Directors"  # (translatable)
BLOG_TITLE = "South Island Whitewater Club"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://www.siwhitewater.club/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://www.siwhitewater.club/"
BLOG_EMAIL = "webmaster@siwhitewater.club"
BLOG_DESCRIPTION = "Welcome to the South Island Whitewater Club"  # (translatable)
